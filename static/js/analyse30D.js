...
const currentURL30D = window.location.href;
const parts30D = currentURL30D.split('/');
const lastPart30D = parts30D[parts30D.length - 1];
const identifier30D = parseInt(lastPart30D);

fetch('../tinder30D/' + identifier30D)
  ...
  .then(csvData => {
	...
	// Calculate and populate match rate values
      ...
      var ctx = document.getElementById('TinderChart30D').getContext('2d');
